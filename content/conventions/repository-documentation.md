...
description: Conventions for README files, agent instructions, specs and local documentation inside code repositories.
---
...
Specs under `docs/specs/` describe concrete work: requirements, analysis, plans, execution and summaries. For format and workflow, see [Specs-Driven Development](/ai-assisted-development/specs-driven-development).

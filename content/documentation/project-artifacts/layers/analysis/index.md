...
description: Needs, requirements, use cases and business rules for understanding the problem.
type: guide
audience: Analysis, business and domain people.
canonical: true
...
hero:
  ...
  actions:
    - theme: brand
      text: View Need
      link: /documentation/project-artifacts/layers/analysis/templates/need
    - theme: alt
      text: View Requirement
      link: /documentation/project-artifacts/layers/analysis/templates/requirement
    - theme: alt
      text: View Use Case
      link: /documentation/project-artifacts/layers/analysis/templates/use-case
...
features:
  ...
  - icon: 📏
    ...
    link: /documentation/project-artifacts/layers/analysis/templates/business-rule
---

...
description: ADRs and contracts for lasting technical decisions and interfaces.
type: guide
audience: Architecture and technical engineering people.
canonical: true
...
hero:
  ...
  actions:
    - theme: brand
      text: View ADR
      link: /documentation/project-artifacts/layers/architecture/templates/adr
    - theme: alt
      text: View Contract
      link: /documentation/project-artifacts/layers/architecture/templates/contract
    - theme: alt
      text: View Engineering
      link: /engineering/

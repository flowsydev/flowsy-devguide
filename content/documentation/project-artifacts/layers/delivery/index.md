...
description: Epics, PBIs and tasks for organizing and prioritizing team work.
type: guide
audience: Delivery, product and development people.
canonical: true
...
hero:
  ...
  actions:
    - theme: brand
      text: View Epic
      link: /documentation/project-artifacts/layers/delivery/templates/epic
    - theme: alt
      text: View PBI
      link: /documentation/project-artifacts/layers/delivery/templates/pbi
    - theme: alt
      text: View Task
      link: /documentation/project-artifacts/layers/delivery/templates/task

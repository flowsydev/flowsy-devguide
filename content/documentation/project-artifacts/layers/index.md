---
layout: section-home
title: Disciplinary Layers Reference
description: Broad catalog of layers and templates; the Project Artifacts landing keeps the canonical decision path.
type: reference
audience: People who need to choose or implement a disciplinary artifact.
canonical: false
canonicalSource: /documentation/project-artifacts/
...
hero:
  ...
  actions:
    - theme: brand
      text: View Strategy
      link: /documentation/project-artifacts/layers/strategy/
    - theme: alt
      text: View Analysis
      link: /documentation/project-artifacts/layers/analysis/
    - theme: alt
      text: View Architecture
      link: /documentation/project-artifacts/layers/architecture/
...
features:
  ...
  - icon: 📦
    ...
    link: /documentation/project-artifacts/layers/delivery/
  - icon: ✅
    title: Validation
    details: Criteria, scenarios and tests to confirm that what was delivered meets expectations.
    link: /documentation/project-artifacts/layers/validation/
  - icon: 📝
...
> [!IMPORTANT]
> This page is the detailed catalog of layers and templates. For organization and IDs, use [Project Artifacts](/documentation/project-artifacts/) as the canonical path.
...
These guidelines also apply to documentation inside code repositories, such as `README.md`, `AGENTS.md`, `CHANGELOG.md`, `docs/` and `docs/specs/`. For that case, see [Repository Documentation](/documentation/repositories/).
...
Subdomain and module folder names and artifact file slugs should follow the project's ubiquitous language decision. See [Ubiquitous Language](/foundations/ubiquitous-language) for guidance on choosing and applying the domain language consistently across code, data models and documentation.
...
For the canonical short catalog, see [Identifiers and Traceability](/documentation/project-artifacts/identifiers-and-traceability). The table below keeps complementary conventions and bilingual examples.

...
description: Acceptance criteria, GWT scenarios and test cases for verifying delivered work.
type: guide
audience: Quality, analysis and delivery people.
canonical: true
...
hero:
  ...
  actions:
    - theme: brand
      text: View Criteria
      link: /documentation/project-artifacts/layers/validation/templates/acceptance-criteria
    - theme: alt
      text: View GWT
      link: /documentation/project-artifacts/layers/validation/templates/gwt-scenario
    - theme: alt
      text: View Test Cases
      link: /documentation/project-artifacts/layers/validation/templates/test-case

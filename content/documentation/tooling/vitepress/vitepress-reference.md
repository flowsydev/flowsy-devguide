---
title: Broad VitePress Reference
description: Quick start, configuration, disciplinary structure, layouts, plugins and deployment examples; progressive pages keep the canonical path.
type: reference
audience: People who need complete VitePress examples.
canonical: false
canonicalSource: /documentation/tooling/vitepress/
---

# VitePress

> [!IMPORTANT]
> This page is a broad non-normative reference. Follow [VitePress](/documentation/tooling/vitepress/) for the canonical progressive path.

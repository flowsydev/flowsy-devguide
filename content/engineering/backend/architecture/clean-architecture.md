...
description: Layer separation focused on protecting the domain and dependency boundaries.
type: guide
...
- See [Vertical Slice Architecture](/engineering/backend/architecture/vertical-slice-architecture) for details on combining both approaches.
...
See [Error Handling](/engineering/backend/reliability/error-handling) for validation order, transaction boundaries and infrastructure error translation.

...
description: Organization by feature and complete use cases for backend change.
type: guide
...
See also [Backend Project Design Baseline: General Anti-Patterns](/engineering/backend/design-baseline#general-anti-patterns) and [DDD: Anti-Patterns](/foundations/domain-modeling/domain-driven-design-reference).
...
See [Error Handling](/engineering/backend/reliability/error-handling) for the full validation, transaction and infrastructure-error guidance.

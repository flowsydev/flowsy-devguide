---
title: MySQL and MariaDB Conventions
description: Naming and modeling guidelines for MySQL and MariaDB in the Flowsy ecosystem.
type: profile
audience: People designing or operating MySQL or MariaDB schemas.
canonical: true
...
Use the aggregate-oriented routine design from [Migration Concepts](/engineering/data/migrations/concepts#aggregate-based-routine-design). This page only defines the MySQL and MariaDB physical naming style: lower `snake_case`.
...
- See [Database Migrations: Concepts](/engineering/data/migrations/concepts) and [Migration Tools and Strategies](/engineering/data/migrations/tools-and-strategies).

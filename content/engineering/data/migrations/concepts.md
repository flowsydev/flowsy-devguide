...
description: Tool-agnostic strategy for evolving schemas and SQL artifacts.
type: guide
audience: Data, backend and platform people.
canonical: true
---
...
- [Data and Migrations: Relational Modeling](../relational-modeling) — relational schema design, primary keys, foreign keys and audit columns.
- [Migration Tools and Strategies](./tools-and-strategies) — tool-specific models and naming.
- [flwdb CLI](./flwdb-cli) — Flowsy CLI usage with Evolve-style `V*` and `R__*` scripts.
- [PostgreSQL Conventions](../database-engines/postgresql) — PostgreSQL-specific naming and modeling.
- [SQL Server Conventions](../database-engines/sql-server) — SQL Server-specific naming and modeling.
- [MySQL and MariaDB Conventions](../database-engines/mysql-mariadb) — MySQL/MariaDB-specific naming and modeling.
- [Domain-Driven Design](/foundations/domain-modeling/domain-driven-design-reference) — aggregate design that gives rise to routines.

---
title: Migration Tools and Strategies Reference
description: Comparative recipes and naming for Evolve, Flyway, Liquibase, DbUp, EF Core, Sqitch and Atlas.
type: reference
audience: People comparing migration tooling in depth.
canonical: false
...
> [!IMPORTANT]
> Prefer the decision-focused guide [Tools and Strategies](./tools-and-strategies). This page keeps comparative recipes.
...
> [!info] ℹ️ flwdb
> When convenient for the team and the project, use the [flwdb CLI](./flwdb-cli) for running Evolve/Flyway-style migrations.

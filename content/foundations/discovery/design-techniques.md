...
description: Recommended visual and collaborative techniques for analysis, design and system communication.
type: guide
...
See the complete guide at [Event Storming](/foundations/discovery/event-storming).
...
See the [Domain Modeling](/foundations/domain-modeling/) guide for more context on Bounded Contexts and integration patterns.

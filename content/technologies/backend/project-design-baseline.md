...
- [Vertical Slice Architecture](./vertical-slice-architecture/concepts.md) when organizing code by feature or use case.
- [Clean Architecture](./clean-architecture/concepts.md) when organizing dependencies around a protected domain core.
- [HTTP API Design](./api-design.md) when defining routes, methods, status codes, Problem Details or OpenAPI contracts.
- [Error Handling](./error-handling.md) when deciding validation flow, domain errors, transaction boundaries, infrastructure failures or side effects.
- [Data and Migrations](./data-and-migrations/relational-modeling.md) when modeling relational structures or schema evolution.
...
- Conduct [Event Storming](../../discovery/event-storming.md) or another collaborative discovery technique with stakeholders.
...
Use [Specs-Driven Development](../../ai-assisted-development/specs-driven-development.md) and the [Project Documentation](../../discovery/documentation/index.md) guidance when work needs structured analysis or agent-friendly context.
...
- [Ubiquitous Language](../../discovery/ubiquitous-language.md)
- [Event Storming](../../discovery/event-storming.md)
- [Domain-Driven Design](../../discovery/domain-driven-design.md)
- [Project Documentation](../../discovery/documentation/index.md)
- [Specs-Driven Development](../../ai-assisted-development/specs-driven-development.md)

...
- [Domain-Driven Design](./domain-driven-design.md) — DDD concepts that complement Event Storming.
- [VSA: Concepts](../technologies/backend/vertical-slice-architecture/concepts.md) — how to implement the identified slices.

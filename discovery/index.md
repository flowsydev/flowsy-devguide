...
features:
  ...
  - icon: 🟧
    ...
    details: Workshop to discover events, commands, policies and domain boundaries together with the business.
    link: /discovery/event-storming
  - icon: 🎯
    title: Domain-Driven Design
    details: Pragmatic principles for modeling contexts, ubiquitous language and business rules.
    link: /discovery/domain-driven-design
  - icon: 🗂️
    title: Project Documentation
    details: Artifact structure by strategy, analysis, architecture, delivery and validation.
    link: /discovery/documentation/
---
